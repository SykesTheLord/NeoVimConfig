...
local function mapv(lhs, fn, desc) vim.keymap.set({ "n", "v" }, lhs, fn, { desc = desc }) end
local function mapt(lhs, fn, desc) vim.keymap.set({ "n", "t" }, lhs, fn, { desc = desc }) end
local function mapx(lhs, fn, desc) vim.keymap.set({ "n", "x" }, lhs, fn, { desc = desc }) end
...
-- LSP pickers override the LSP buf bindings globally
